...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function createCard(data) {
    ...
    // Function to toggle the hovered box
    ...
    // Add click event listener for toggle functionality on mobile devices
    ...
    function showDescription() {
      const hoveredBox = document.createElement("div");
      hoveredBox.classList.add("hovered-box");
      hoveredBox.innerHTML = `<h1>${data.title}</h1><p>${data.description}</p>`;
      card.appendChild(hoveredBox);
    }
